...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '**科技',   0, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'cloud', '15888888888', '15838125896@163.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'cloud', '00', '15838125896@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '管理员');
insert into sys_user values(2,  105, 'cloud',    'cloud', '00', '15838125896@163.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '测试员');
...
insert into sys_config values(4, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false',         'Y', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '是否开启注册用户功能');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 cloud新版本发布啦', '2', '新版本内容', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 cloud系统凌晨维护', '1', '维护内容',   '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
...
-- 21、商品信息表
-- ----------------------------
drop table if exists zsy_product;
CREATE TABLE `zsy_product` (
  `external_product_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `external_product_id_type` varchar(20) NOT NULL DEFAULT '' COMMENT '商品唯一识别码类型 全球通用 中国为69开头 13位',
  `item_sku` varchar(64) NOT NULL DEFAULT '' COMMENT '商品sku',
  `item_name` varchar(255) NOT NULL DEFAULT '' COMMENT '商品名称',
  `brand_name` varchar(255) DEFAULT '' COMMENT '品牌名称',
  `manufacturer` varchar(255) DEFAULT '' COMMENT '厂商名 生产厂家的名字 可以用中文拼音和品牌名组合',
  `part_number` varchar(255) DEFAULT '' COMMENT '厂商编号',
  `product_description` varchar(255) DEFAULT '' COMMENT '产品描述',
  `feed_product_type` varchar(255) DEFAULT '' COMMENT '商品大分类 务必要准确 作为关键词被搜索',
  `currency` varchar(255) DEFAULT '' COMMENT '币别',
  `website_shipping_weight` varchar(255) DEFAULT '' COMMENT '网站发货重量',
  `website_shipping_weight_unit_of_measure` varchar(255) DEFAULT '' COMMENT '网站发货重量的计量单位',
  `item_weight` varchar(255) DEFAULT '' COMMENT '产品重量',
  `item_weight_unit_of_measure` varchar(255) DEFAULT '' COMMENT '产品重量的计量单位',
  `bullet_point1` varchar(255) DEFAULT '' COMMENT '产品特点-1',
  `bullet_point2` varchar(255) DEFAULT '' COMMENT '产品特点-2',
  `bullet_point3` varchar(255) DEFAULT '' COMMENT '产品特点-3',
  `bullet_point4` varchar(255) DEFAULT '' COMMENT '产品特点-4',
  `bullet_point5` varchar(255) DEFAULT '' COMMENT '产品特点-5',
  `generic_keywords1` varchar(255) DEFAULT '' COMMENT '商品关键字-1',
  `generic_keywords2` varchar(255) DEFAULT '' COMMENT '商品关键字-2',
  `generic_keywords3` varchar(255) DEFAULT '' COMMENT '商品关键字-3',
  `generic_keywords4` varchar(255) DEFAULT '' COMMENT '商品关键字-4',
  `generic_keywords5` varchar(255) DEFAULT '' COMMENT '商品关键字-5',
  `recommended_browse_nodes1` varchar(255) DEFAULT '' COMMENT '推荐浏览-1',
  `recommended_browse_nodes2` varchar(255) DEFAULT '' COMMENT '推荐浏览-2',
  `main_image_url` varchar(255) NOT NULL DEFAULT '' COMMENT '商品主图',
  `swatch_image_url` varchar(255) NOT NULL DEFAULT '' COMMENT '样本图片',
  `other_image_url1` varchar(255) DEFAULT '' COMMENT '其他图片-1',
  `other_image_url2` varchar(255) DEFAULT '' COMMENT '其他图片-2',
  `other_image_url3` varchar(255) DEFAULT '' COMMENT '其他图片-3',
  `other_image_url4` varchar(255) DEFAULT '' COMMENT '其他图片-4',
  `other_image_url5` varchar(255) DEFAULT '' COMMENT '其他图片-5',
  `other_image_url6` varchar(255) DEFAULT '' COMMENT '其他图片-6',
  `other_image_url7` varchar(255) DEFAULT '' COMMENT '其他图片-7',
  `other_image_url8` varchar(255) DEFAULT '' COMMENT '其他图片-8',
  `standard_price` decimal(10,2) DEFAULT '0.00' COMMENT '成本价',
  `sell_price` decimal(10,2) DEFAULT '0.00' COMMENT '销售价',
  `quantity` int(11) DEFAULT '0' COMMENT '库存',
  `update_delete` varchar(20) DEFAULT '' COMMENT '固定值 更新 删除用delete 部分更新用partiaupdate',
  `condition_type` varchar(255) DEFAULT '' COMMENT '条件类型',
  `condition_note` varchar(255) DEFAULT '' COMMENT '条件说明',
  `parent_id` bigint(20) DEFAULT '0' COMMENT '父id',
  `parent_child` varchar(255) DEFAULT '' COMMENT '直属关系',
  `parent_sku` varchar(255) DEFAULT '' COMMENT '父sku',
  `relationship_type` varchar(255) DEFAULT '' COMMENT '关系类型',
  `variation_theme` varchar(255) DEFAULT '' COMMENT '变化主题',
  `color_name` varchar(255) DEFAULT '' COMMENT '颜色名称',
  `color_map` varchar(255) DEFAULT '' COMMENT '颜色map',
  `size_name` varchar(255) DEFAULT '' COMMENT '尺寸名称',
  `size_map` varchar(255) DEFAULT '' COMMENT '尺寸map',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(255) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`external_product_id`) USING BTREE
